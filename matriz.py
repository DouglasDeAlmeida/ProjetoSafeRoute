...
class Matriz:
    ...
    def ler_fixa(self):
        ...
        matrix =[[2, 2, 2, 50, 12, 12, 12, 12, 3, 3, 3, 3, 30, 30, 30, 30, 30, 99, 99, 99],
    ...
    def carregar_de(self):
        # REQ
        matrix = np.loadtxt(r'C:\Users\PICHAU\Documents\GitHub\CDIA20-pacman2waze\semana15_a-estrela\array.txt')
